...
#include <stdio.h>
#include <stdlib.h>
#include "com_orangelabs_core_ims_protocol_rtp_codec_video_h263_decoder_NativeH263Decoder.h"
...
/*
 * Class:     com_orangelabs_core_ims_protocol_rtp_codec_video_h263_decoder_NativeH263Decoder
 * Method:    InitDecoder
 * Signature: (II)I
 */
JNIEXPORT jint JNICALL Java_com_orangelabs_core_ims_protocol_rtp_codec_video_h263_decoder_NativeH263Decoder_InitDecoder
 ...
 * Signature: ()I
 */
JNIEXPORT jint JNICALL Java_com_orangelabs_core_ims_protocol_rtp_codec_video_h263_decoder_NativeH263Decoder_DeinitDecoder
 ...
 * Signature: ([B[IJ)[I
 */
JNIEXPORT jint JNICALL Java_com_orangelabs_core_ims_protocol_rtp_codec_video_h263_decoder_NativeH263Decoder_DecodeAndConvert
 ...
 */
JNIEXPORT jint JNICALL Java_com_orangelabs_core_ims_protocol_rtp_codec_video_h263_decoder_NativeH263Decoder_InitParser
...
/*
 * Class:     com_orangelabs_core_ims_protocol_rtp_codec_video_Native3GPPFileParser
 * Method:    DeinitParser
 * Signature: ()I
 */
JNIEXPORT jint JNICALL Java_com_orangelabs_core_ims_protocol_rtp_codec_video_h263_decoder_NativeH263Decoder_DeinitParser
  (JNIEnv *env, jclass clazz){
	if (decoderInitialized == 1) deinitDecoder();
	parserInitialized = 0;
	return release();
 ...
 * Signature: ()I
 */
JNIEXPORT jint JNICALL Java_com_orangelabs_core_ims_protocol_rtp_codec_video_h263_decoder_NativeH263Decoder_getVideoLength
  (JNIEnv *env, jclass clazz){
 ...
 * Signature: ()I
 */
JNIEXPORT jint JNICALL Java_com_orangelabs_core_ims_protocol_rtp_codec_video_h263_decoder_NativeH263Decoder_getVideoWidth
  (JNIEnv *env, jclass clazz)
{
 ...
 * Signature: ()I
 */
JNIEXPORT jint JNICALL Java_com_orangelabs_core_ims_protocol_rtp_codec_video_h263_decoder_NativeH263Decoder_getVideoHeight
  (JNIEnv *env, jclass clazz)
{
 ...
 */
JNIEXPORT jstring JNICALL Java_com_orangelabs_core_ims_protocol_rtp_codec_video_h263_decoder_NativeH263Decoder_getVideoCoding
  (JNIEnv *env, jclass clazz)
{
 ...
 * Signature: ([I)Lcom/orangelabs/core/ims/protocol/rtp/codec/video/VideoSample
 */
JNIEXPORT jobject JNICALL Java_com_orangelabs_core_ims_protocol_rtp_codec_video_h263_decoder_NativeH263Decoder_getVideoSample
  (JNIEnv *env, jclass clazz, jintArray Decoded)
{
	...
	jclass classe = (env)->FindClass("com/orangelabs/core/ims/protocol/rtp/codec/video/h263/decoder/VideoSample");
	if (classe == 0) {
	  return object;
	}
