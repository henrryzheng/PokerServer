...
/*
 * Class:     com_orangelabs_core_ims_protocol_rtp_codec_video_h264_encoder_NativeH264Encoder
 * Method:    InitEncoder
 * Signature: (IIF)I
 */
JNIEXPORT jint JNICALL Java_com_orangelabs_core_ims_protocol_rtp_codec_video_h264_encoder_NativeH264Encoder_InitEncoder
  (JNIEnv *env, jclass iclass, jint width, jint height, jint framerate)
{
    /**
      * Init
      */
	 __android_log_print(ANDROID_LOG_INFO, LOG_TAG,  "InitEncoder width =  %d , height = %d , framerate = %d", width, height, framerate);
    iSrcWidth = width;
    iSrcHeight = height;
    iSrcFrameRate = framerate;
    FrameSize = (iSrcWidth*iSrcHeight*3)>>1;

    __android_log_print(ANDROID_LOG_INFO, LOG_TAG,  "InitEncoder  FrameSize = %d", FrameSize);
    ...
    //    iEncodeParam->iLevel = EAVCEI_LEVEL_31;
 ...
 * Signature: ([BJ)[B
 */
JNIEXPORT jbyteArray JNICALL Java_com_orangelabs_core_ims_protocol_rtp_codec_video_h264_encoder_NativeH264Encoder_EncodeFrame
 ...
 * Signature: ()I
 */
JNIEXPORT jint JNICALL Java_com_orangelabs_core_ims_protocol_rtp_codec_video_h264_encoder_NativeH264Encoder_getLastEncodeStatus
 ...
 * Signature: ()I
 */
JNIEXPORT jint JNICALL Java_com_orangelabs_core_ims_protocol_rtp_codec_video_h264_encoder_NativeH264Encoder_DeinitEncoder
  (JNIEnv *env, jclass clazz){
    delete(encoder);
    free(iInputFormat);
    free(iEncodeParam);
