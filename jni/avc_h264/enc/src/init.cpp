...
AVCEnc_Status VerifyLevel(AVCEncObject *encvid, AVCSeqParamSet *seqParam, AVCPicParamSet *picParam)
{
   ...
   // __android_log_print(ANDROID_LOG_INFO, LOG_TAG,  "seqParam->level_idc = %d",seqParam->level_idc);
 ...
 //   __android_log_print(ANDROID_LOG_INFO, LOG_TAG,  "lev_idx = %d",lev_idx);
 //   __android_log_print(ANDROID_LOG_INFO, LOG_TAG,  "seqParam->level_idc = %d",seqParam->level_idc);
 //   __android_log_print(ANDROID_LOG_INFO, LOG_TAG,  "mb_per_sec = %d",mb_per_sec);
 //   __android_log_print(ANDROID_LOG_INFO, LOG_TAG,  "MaxMBPS[lev_idx] = %ld",MaxMBPS[lev_idx]);
 //   __android_log_print(ANDROID_LOG_INFO, LOG_TAG,  "PicSizeInMbs = %ld",video->PicSizeInMbs);
 //   __android_log_print(ANDROID_LOG_INFO, LOG_TAG,  "MaxFS[lev_idx] = %d",MaxFS[lev_idx]);
 //   __android_log_print(ANDROID_LOG_INFO, LOG_TAG,  "(int32)MaxBR[lev_idx] = %d",(int32)MaxBR[lev_idx]);
 //   __android_log_print(ANDROID_LOG_INFO, LOG_TAG,  "rateCtrl->bitRate = %ld",rateCtrl->bitRate);
