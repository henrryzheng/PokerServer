...
int my_jiance_barcode0307(short*Im_0, int nr, int nc, my_space *Consequence)
{
	...
	//my_mean_fast(Iout2, Im_temp, Im2, nc2, nr2, 2);
	...
	//检测
	int P_jiance = 0;
	P_jiance = my_barcode_gai_1211(Im, Iout22, nr2, nc2, Consequence);
