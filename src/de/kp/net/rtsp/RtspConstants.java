...
public class RtspConstants {
	...
	public static int RTP_MediaCodec_PAYLOADTYPE = 98;
	...
	public static String MediaCodec = "MediaCodec/90000";
...
//	public static String HEIGHT = "144";
	...
	// QCIF
//	public static String WIDTH  = "704";
//	public static String HEIGHT = "576";
...
//	public static String SERVER_IP = "spexhd2:8080";
   ...
   // public static String SERVER_IP = getLocalIpAddress() + ":" + SERVER_PORT;
    public static String SERVER_IP = "192.168.43.1" + ":" + SERVER_PORT;		
