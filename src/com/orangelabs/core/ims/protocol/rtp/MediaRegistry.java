...
package com.orangelabs.core.ims.protocol.rtp;
...
import com.orangelabs.core.ims.protocol.rtp.format.audio.AudioFormat;
import com.orangelabs.core.ims.protocol.rtp.format.audio.PcmuAudioFormat;
...
public class MediaRegistry {
    ...
    public static Codec[] generateEncodingCodecChain(String encoding) {
    	if (encoding.toLowerCase().equalsIgnoreCase(H263VideoFormat.ENCODING)) {
    		...
    		Codec[] chain = {
    			new com.orangelabs.core.ims.protocol.rtp.codec.video.h263.JavaPacketizer()
    		};
    		return chain;
		} else { 
	...
	public static Codec[] generateDecodingCodecChain(String encoding) {
    	if (encoding.toLowerCase().equalsIgnoreCase(H263VideoFormat.ENCODING)) {
    		...
    		Codec[] chain = {
    			new com.orangelabs.core.ims.protocol.rtp.codec.video.h263.JavaDepacketizer()
    		};
    		return chain;
		} else { 
			// Codec implemented in the native part
